...
//     // Shuffle the answer options of the next question
...
//     // Dispatch the shuffled answers along with advancing to the next question
//     dispatch({
//       type: "SET_SELECTED_ANSWER",
//       payload: [],
...
//       type: "SET_QUESTIONS",
//       payload: [
//         ...state.questions.slice(0, nextQuestionIndex),
//         {
//           ...nextQuestion,
//           correct_answer: shuffledAnswers[0], // Update the correct answer
//           incorrect_answers: shuffledAnswers.slice(1), // Update the incorrect answers
//         },
//         ...state.questions.slice(nextQuestionIndex + 1),
//       ],
//     });
//   } else {
//     navigate("/");
